...
calculator opens a simple calculator, it's pretty intuitive.
password ganerator opens a password creator. It works by using the random module to create random password sequences. You have a 'username' and a 'webpage' entries, they're not important, put whatever you like. They'll be used later. When you press 'calculate' it'll create a password.txt file in which you'll have written the username and webpage you put in, other than the password. This file will be in the same repository as the main one.
The search on web opens a window, put in whatever you like and press the search button. It'll open a google search with whatever you've put in in your default browser.
